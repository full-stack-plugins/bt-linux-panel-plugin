...
```bash
node scripts/bump-plugin.mjs bt-linux-panel patch   # 文档/注释/小修复
node scripts/bump-plugin.mjs bt-linux-panel minor   # 新功能
node scripts/bump-plugin.mjs bt-linux-panel major   # 破坏性变更
```
